                    ...
                    <table class="w-full text-sm text-center border-collapse">
                        <thead>
                            <tr class="bg-slate-50/50 border-b border-slate-200">
                                <th class="sticky left-0 bg-slate-50 z-20 px-6 py-3 min-w-[200px] text-left border-r border-slate-200">
                                ...
                                @foreach(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'] as $day)
                                    <th class="px-2 py-3 border-r border-slate-100 last:border-slate-200" colspan="{{ $day === 'Saturday' ? '1' : '2' }}">
                                        ...
                                        <span class="text-[9px] font-bold text-slate-400 uppercase">{{ $attendance->week_start_date->addDays($loop->index)->format('d M') }}</span>
                                    </th>
                                @endforeach
                            </tr>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @foreach($employees as $employee)
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    <td class="sticky left-0 bg-white group-hover:bg-slate-50 z-10 px-6 py-2.5 border-r border-slate-200 text-left shadow-[5px_0_15px_-5px_rgba(0,0,0,0.05)] transition-colors">
                                        <div class="flex items-center gap-2.5">
                                            ...
                                            <div class="flex flex-col">
                                                <span class="font-bold text-slate-800 leading-none mb-0.5 text-xs">{{ $employee->full_name }}</span>
