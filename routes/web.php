...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/settings/codes', [App\Http\Controllers\Admin\SystemSettingController::class, 'storeCode'])->name('settings.store_code');
        Route::put('/settings/codes/{code}', [App\Http\Controllers\Admin\SystemSettingController::class, 'updateCode'])->name('settings.update_code');
        Route::delete('/settings/codes/{code}', [App\Http\Controllers\Admin\SystemSettingController::class, 'destroyCode'])->name('settings.destroy_code');
